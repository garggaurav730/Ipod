...
class Ipod extends React.Component {
  ...
  spinWheel = () => {
    //give the rotation effect to the wheel button using zingtouch
  ...
  render() {
    return (
      <div style={styles.ipodContainer}>
        ...
        {/* display the different button on wheel */}
        ...
        <div
          id="inner-container"
          style={styles.wheel}
          onMouseOver={this.spinWheel}
        >
          <div style={styles.buttonContainer}>
            <div style={styles.menuButton}>
              <i
                onClick={this.switchPageToHomeScreen}
                style={styles.image}
...
// give style to ipod container,wheel,button, etc
